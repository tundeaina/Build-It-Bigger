 ...
 * on 2015-12-17 at 01:58:10 UTC 
 * Modify at your own risk.
 */

package com.aina.adnd.jokeserver.jokesApi;
...
public class JokesApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://android-nanodegree-joker.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "nextJoke".
   *
   * This request holds the parameters needed by the jokesApi server.  After setting any optional
   * parameters, call the {@link NextJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public NextJoke nextJoke() throws java.io.IOException {
    NextJoke result = new NextJoke();
    initialize(result);
    return result;
  }

  public class NextJoke extends JokesApiRequest<com.aina.adnd.jokeserver.jokesApi.model.JokesBean> {

    private static final String REST_PATH = "nextJoke";

    /**
     * Create a request for the method "nextJoke".
     *
     * This request holds the parameters needed by the the jokesApi server.  After setting any
     * optional parameters, call the {@link NextJoke#execute()} method to invoke the remote operation.
     * <p> {@link
     * NextJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected NextJoke() {
      super(JokesApi.this, "POST", REST_PATH, null, com.aina.adnd.jokeserver.jokesApi.model.JokesBean.class);
    }

    @Override
    public NextJoke setAlt(java.lang.String alt) {
      return (NextJoke) super.setAlt(alt);
    }

    @Override
    public NextJoke setFields(java.lang.String fields) {
      return (NextJoke) super.setFields(fields);
    }

    @Override
    public NextJoke setKey(java.lang.String key) {
      return (NextJoke) super.setKey(key);
    }

    @Override
    public NextJoke setOauthToken(java.lang.String oauthToken) {
      return (NextJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public NextJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (NextJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public NextJoke setQuotaUser(java.lang.String quotaUser) {
      return (NextJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public NextJoke setUserIp(java.lang.String userIp) {
      return (NextJoke) super.setUserIp(userIp);
    }

    @Override
    public NextJoke set(String parameterName, Object value) {
      return (NextJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends JokesApiRequest<com.aina.adnd.jokeserver.jokesApi.model.JokesBean> {
